...
\\
\>[B]{}\Varid{restantes}\mathrel{=}(\mathbin{/})\mathbin{\mathopen{\langle}\$\mathclose{\rangle}}\Varid{fromIntegral}\comp (\p1\comp \p2)\mathbin{<*>}\Varid{fromIntegral}\comp \succ \comp (\p2\comp \p2){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to ()+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu])\mbox{\onelinecomment  coloca em pares (para poder usar merge)}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{lsplitk''}\;\Varid{k}\;\Varid{xs}\mathrel{=}i_2\;(\Varid{lsplitk}\;\Varid{k}\;\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lrh}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{lrh}\;\Varid{heights}\mathrel{=}\Varid{maximum}\comp \map \;\Varid{calculaArea}\comp \Varid{geraListas}\mathbin{\$}\Varid{heights}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
